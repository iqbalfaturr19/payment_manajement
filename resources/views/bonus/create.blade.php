                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route('bonuses.store') }}" method="POST">
                        ...
                        <div class="form-group{{ $errors->has('total_bonus') ? ' has-error' : '' }}">
                            ...
                            <input id="total_bonus" type="text" class="form-control" name="total_bonus" value="{{ old('total_bonus') }}" required>
                        </div>
                        ...
                        <div id="bonus-container" class="form-group">
                            <div class="row mb-2 form-group bonus-row">
                                ...
                                <div class="col-md-3">
                                    <input type="number" name="percentage[]" class="form-control percentage" placeholder="Persentase Bonus (%)" required min="0" max="100" required>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <a class="btn btn-default" href="{{route('bonuses.index')}}">
                                Cancel
                            </a>
                        </div>
                    </form>
